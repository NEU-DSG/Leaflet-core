    ...
    var geojson = L.geoJson(data, {
      onEachFeature: function (feature, layer) {
        (function(layer, properties) {
          ...
          var output = {
            "containerId": 'container' + Math.random().toString(36),
            "workDescription": feature.properties['workDescription'],
            "imgSrc": feature.properties['image'],
            "srcHref": feature.properties['work'],
            "srcText": feature.properties['workLabel'],
